...
```
The goal of mulset is to generate specific type of multi-set intersections. It searches for multi set intersections between rows and corresponding column identifiers.

## Installation

You can install the released version of mulset from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("mulset")
```
Or you can install **mulset** directly from **github** with use of following commands:
